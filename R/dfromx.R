...
#' @param d2shr.we
#'   A numeric vector of length 2, distance (in the "x" direction) from
#'   west and east shores excluded from lake (in m).
#' @param eastr
#'   A numeric vector of length 2, easting range (minimum and maximum)
#'   corresponding to the west and east shores of the lake (in m).
#' @return
#'   A numeric vector, same length as \code{x}, with distances to shore
