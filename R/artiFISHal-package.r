...
#' 
#' An example of how to use the functions in \pkg{artiFISHal} is given in this vignette
...
#' Written in programming language R (R Core Team, 2014, \href{http://www.R-project.org}{R-project.org}), version 3.1.1 (2014-07-10).
...
#' Source code is available from Jean V. Adams on GitHub \href{https://github.com/JVAdams/artiFISHal}{github.com/JVAdams/LW1949}, \emph{jvadams (at) usgs (dot) gov}.
#'
